...
| `useradd` | Para crear un nuevo usuario con sus respectivos directorios y funciones, cosa que lo hace distintos de adduser |   | `sudo useradd -m Test -G wheel -p 123 ` creará el usuario "Test" en el grupo wheel con la contraseña 123 |
