...
| :---: | :---: | :---: | :---: |
| <code>&#124;<\code> | Este símbolo llamado pipe sirve para concatenar dos comandos  | Por si solo no es un comando | <code> ps -aux &#124; grep "firefox"<\code> busca en la lista de procesos alguno llamado Firefox |
